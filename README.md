...
```bash
git clone https://github.com/organization-codeflow/cn-webmanguonmo-ttm-react.git
cd cn-webmanguonmo-ttm-react
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=cn-webmanguonmo-ttm-react
- Xem các metrics:
